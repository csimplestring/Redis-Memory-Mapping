...
void mmapHmsetCommand(redisClient *c)
{
...
void hmsetCommand(redisClient *c) {
    ...
    // after hash is added into memory, swap it into mmap-file
    if(server.mmap_enabled){
		vmpointer *vp ;
		robj *v, *key;
		if( (vp = mmapSwapObjectBlocking(o)) == NULL)
		{
